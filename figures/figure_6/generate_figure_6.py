"""Entry point for generating individual panels of Figure 6.

This script does not assemble the final multi-panel figure. The final figure was arranged in a graphics editor (Inkscape) to best position panels before manuscript submission. This script will generate the individual panels, which can then be manually arranged in a graphics editor to create the final figure. The script will run each of the individual panel generation scripts in sequence, and print a message when all panels have been generated. Panel D is a schematic created manually using SVG editing software (Inkscape).
"""
...
def main():
    ...
    print("All requested Figure 6 panel scripts completed.")
